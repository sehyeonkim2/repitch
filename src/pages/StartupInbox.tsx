...
const StartupInbox = () => {
  ...
  const { startupInboxProposals } = useApp();
  const proposals = [...startupInboxProposals].sort((a, b) =>
            ...
            {proposals.map((proposal, i) => {
              ...
              return (
                <motion.button
                  ...
                  type="button"
                  onClick={() => navigate(`/startup/inbox/${proposal.id}`)}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-on-surface-variant">{inf.category} · {inf.followers.toLocaleString("ko-KR")}명</p>

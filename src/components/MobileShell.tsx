...
export const MobileShell = ({ children }: MobileShellProps) => (
  <div className="min-h-screen bg-surface-dim sm:py-8 flex justify-center sm:items-center">
    <div className="relative w-full max-w-[440px] bg-background flex flex-col min-h-screen sm:min-h-0 sm:h-[844px] sm:rounded-[2.5rem] sm:shadow-[0_24px_64px_rgba(0,0,0,0.18)] sm:overflow-hidden">
